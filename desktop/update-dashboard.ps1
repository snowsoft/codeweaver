...
if (Test-Path "src/views/Dashboard/index.tsx") {
    Copy-Item "src/views/Dashboard/index.tsx" "src/views/Dashboard/index.tsx.bak" -Force
}

# Write new content
Set-Content -Path "src/views/Dashboard/index.tsx" -Value $dashboardContent -Encoding UTF8
Write-Host "Dashboard component updated successfully!"

# Verify the export lines
Write-Host "`nLast 5 lines of Dashboard component:"
Get-Content "src/views/Dashboard/index.tsx" -Tail 5